package com.myst25.quicksearch.widgets.customButtonsWidget
...
import com.myst25.quicksearch.search.contacts.utils.TelegramContactUtils
...
class WidgetActionActivity : ComponentActivity() {
    ...
    companion object {
        const val EXTRA_CUSTOM_BUTTON_ACTION =
            "com.myst25.quicksearch.extra.CUSTOM_WIDGET_BUTTON_ACTION"
