...
import com.myst25.quicksearch.settings.AppShortcutsSettings.AppShortcutSource
import com.myst25.quicksearch.settings.shared.SettingsCommand
import com.myst25.quicksearch.settings.shared.SettingsCard
import com.myst25.quicksearch.settings.shared.SettingsCardItem
import com.myst25.quicksearch.settings.shared.SettingsNavigationRow
...
import com.myst25.quicksearch.settings.shared.SettingsManagementSearchBar
import com.myst25.quicksearch.settings.shared.settingsContentWidth
import com.myst25.quicksearch.settings.AppShortcutsSettings.AppShortcutsSettingsSection
...
import com.myst25.quicksearch.settings.NoteDeleteConfirmationDialog
import com.myst25.quicksearch.settings.NotesBulkDeleteConfirmationDialog
import com.myst25.quicksearch.settings.settingsDetailScreen.CustomToolNavigationMemory
    ...
    Box(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            if (detailType == SettingsDetailType.APP_MANAGEMENT) {
                ...
                com.myst25.quicksearch.settings.customTools.CustomToolEditorScreen(
                        ...
                        SettingsDetailType.FILES -> {
                            FileTypesSection(
                                ...
                                onToggleFolders = { enabled ->
                                    callbacks.onApplySettingsCommand(
                                        SettingsCommand.Toggle(
                                            key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.SHOW_FOLDERS,
                                            enabled = enabled,
                                        ),
                                    )
                                },
                                ...
                                onToggleSystemFiles = { enabled ->
                                    callbacks.onApplySettingsCommand(
                                        SettingsCommand.Toggle(
                                            key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.SHOW_SYSTEM_FILES,
                                            enabled = enabled,
                                        ),
                                    )
                                },
