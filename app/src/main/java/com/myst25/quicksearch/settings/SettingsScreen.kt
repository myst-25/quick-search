package com.myst25.quicksearch.settings.settingsScreen

import android.content.ActivityNotFoundException
import com.myst25.quicksearch.settings.shared.SettingsScreenCallbacks as SharedSettingsScreenCallbacks
import com.myst25.quicksearch.settings.shared.SettingsScreenState as SharedSettingsScreenState
...
import com.myst25.quicksearch.search.data.preferences.BasePreferences
...
import com.myst25.quicksearch.shared.featureFlags.FeatureFlag
...
fun SettingsScreen(
    ...
    val hasNotesForExport =
        remember(userPrefs) {
            FeatureFlags.isSearchSectionEnabled(com.myst25.quicksearch.search.core.SearchSection.NOTES) &&
                run {
...
fun SettingsMoreOptions(
    ...
    val onOpenGitHub = {
        val url = "https://github.com/myst-25/quick-search"
        try {
...
fun SettingsVersionDisplay(
    ...
    Column(
        ...
        Text(
            ...
            modifier =
                Modifier.clickable {
                    val url = "https://github.com/myst-25"
                    try {
