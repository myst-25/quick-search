...
import com.myst25.quicksearch.searchEngines.getDisplayNameResId
...
import com.myst25.quicksearch.searchEngines.isSearchTargetShortcutPackageName
                ...
                .flatMap { target ->
                    val baseSource =
                        SearchTargetShortcutSource(
                            target = target,
                            packageName =
                                com.myst25.quicksearch.searchEngines.resolveSearchTargetShortcutPackageName(
                                    target = target,
