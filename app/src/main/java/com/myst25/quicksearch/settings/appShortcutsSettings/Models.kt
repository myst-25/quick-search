...
enum class ShortcutFilterOption(val labelResId: Int) {
    ALL(com.myst25.quicksearch.R.string.settings_app_shortcuts_filter_all_apps),
    APPS_WITH_SHORTCUTS(com.myst25.quicksearch.R.string.settings_app_shortcuts_filter_apps_with_shortcuts),
    SEARCH_ENGINES(com.myst25.quicksearch.R.string.settings_app_shortcuts_filter_search_engines),
    BROWSERS(com.myst25.quicksearch.R.string.settings_app_shortcuts_filter_browsers),
}