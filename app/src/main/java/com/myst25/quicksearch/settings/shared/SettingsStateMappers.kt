...
private data class SearchResultsMapperState(
    val suggestionExcludedApps: List<com.myst25.quicksearch.search.models.AppInfo>,
    val resultExcludedApps: List<com.myst25.quicksearch.search.models.AppInfo>,
    val excludedContacts: List<com.myst25.quicksearch.search.models.ContactInfo>,
    val excludedFiles: List<com.myst25.quicksearch.search.models.DeviceFile>,
    val excludedSettings: List<com.myst25.quicksearch.search.deviceSettings.DeviceSetting>,
    val excludedAppShortcuts: List<com.myst25.quicksearch.search.data.AppShortcutRepository.StaticShortcut>,
    val disabledSections: Set<com.myst25.quicksearch.search.core.SearchSection>,
    val appSuggestionsEnabled: Boolean,
    val enabledAppSuggestionTabs: Set<com.myst25.quicksearch.search.core.AppSuggestionTabType>,
    ...
    val topMatchesSectionOrder: List<com.myst25.quicksearch.search.core.SearchSection>,
    val disabledTopMatchesSections: Set<com.myst25.quicksearch.search.core.SearchSection>,
...
private data class SearchEngineMapperState(
    val searchEngineOrder: List<com.myst25.quicksearch.search.core.SearchTarget>,
    ...
    val availableGeminiModels: List<com.myst25.quicksearch.tools.aiSearch.GeminiTextModel>,
    val availableLlmModelsByProvider: Map<AiSearchLlmProviderId, List<com.myst25.quicksearch.tools.aiSearch.GeminiTextModel>>,
)
...
private data class AppearanceMapperState(
    ...
    val appTheme: com.myst25.quicksearch.search.core.AppTheme,
    val overlayThemeIntensity: Float,
    val appThemeMode: com.myst25.quicksearch.search.core.AppThemeMode,
    val fontScaleMultiplier: Float,
    val useSystemFont: Boolean,
    val backgroundSource: com.myst25.quicksearch.search.core.BackgroundSource,
    val customImageUri: String?,
    val selectedIconPackPackage: String?,
    val availableIconPacks: List<com.myst25.quicksearch.search.core.IconPackInfo>,
    val maskUnsupportedIconPackIcons: Boolean,
    val showAppLabels: Boolean,
    val phoneAppGridColumns: Int,
    val appIconSizeStep: Int,
    val appIconShape: com.myst25.quicksearch.search.core.AppIconShape,
    val launcherAppIcon: com.myst25.quicksearch.search.core.LauncherAppIcon,
...
private data class AppShortcutsMapperState(
    val allAppShortcuts: List<com.myst25.quicksearch.search.data.AppShortcutRepository.StaticShortcut>,
    val allDeviceSettings: List<com.myst25.quicksearch.search.deviceSettings.DeviceSetting>,
    val allApps: List<com.myst25.quicksearch.search.models.AppInfo>,
    val disabledAppShortcutIds: Set<String>,
    val messagingApp: com.myst25.quicksearch.search.core.MessagingApp,
    val callingApp: com.myst25.quicksearch.search.core.CallingApp,
