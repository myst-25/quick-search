...
import com.myst25.quicksearch.search.utils.PermissionUtils
import com.myst25.quicksearch.searchEngines.getId
import com.myst25.quicksearch.shared.permissions.PermissionHelper
import com.myst25.quicksearch.settings.FeaturesList
import com.myst25.quicksearch.settings.OpenSourceLicenseEntry
import com.myst25.quicksearch.settings.OpenSourceLicensesList
import com.myst25.quicksearch.settings.searchEnginesScreen.SearchEngines
import com.myst25.quicksearch.settings.shared.SettingsScreenCallbacks
import com.myst25.quicksearch.settings.shared.SettingsCommand
import com.myst25.quicksearch.settings.shared.SettingsScreenBackground
import com.myst25.quicksearch.settings.shared.SettingsScreenState
import com.myst25.quicksearch.settings.shared.isAppSettingToggleEnabled
import com.myst25.quicksearch.settings.shared.settingsContentWidth
import com.myst25.quicksearch.shared.ui.theme.AppColors
import com.myst25.quicksearch.shared.ui.theme.DesignTokens
import com.myst25.quicksearch.shared.ui.theme.QuickSearchTheme
                    ...
                    SettingsDetailType.SEARCH_ENGINES -> {
                        SearchEngines(
                            ...
                            onToggleSearchEngineCompactMode = { enabled ->
                                callbacks.onApplySettingsCommand(
                                    SettingsCommand.Toggle(
                                        key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.SEARCH_ENGINE_COMPACT_MODE,
                                        enabled = enabled,
                                    ),
                                )
                            },
                            ...
                            onToggleSearchEngineAliasSuffixEnabled = { enabled ->
                                callbacks.onApplySettingsCommand(
                                    SettingsCommand.Toggle(
                                        key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.SEARCH_ENGINE_ALIAS_SUFFIX,
                                        enabled = enabled,
                                    ),
                                )
                            },
                    ...
                    SettingsDetailType.APPEARANCE -> {
                        ...
                        AppearanceSettingsSection(
                            ...
                            onToggleOneHandedMode = { enabled ->
                                callbacks.onApplySettingsCommand(
                                    SettingsCommand.Toggle(
                                        key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.ONE_HANDED_MODE,
                                        enabled = enabled,
                                    ),
                                )
                            },
                            ...
                            onToggleBottomSearchBar = { enabled ->
                                callbacks.onApplySettingsCommand(
                                    SettingsCommand.Toggle(
                                        key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.BOTTOM_SEARCHBAR,
                                        enabled = enabled,
                                    ),
                                )
                            },
                            ...
                            onToggleSearchHints = { enabled ->
                                callbacks.onApplySettingsCommand(
                                    SettingsCommand.Toggle(
                                        key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.SEARCH_HINTS,
                                        enabled = enabled,
                                    ),
                                )
                            },
                            ...
                            onToggleSettingsIcon = { enabled ->
                                callbacks.onApplySettingsCommand(
                                    SettingsCommand.Toggle(
                                        key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.SETTINGS_ICON,
                                        enabled = enabled,
                                    ),
                                )
                            },
                            ...
                            onToggleAppLabels = { enabled ->
                                callbacks.onApplySettingsCommand(
                                    SettingsCommand.Toggle(
                                        key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.APP_LABELS,
                                        enabled = enabled,
                                    ),
                                )
                            },
                            ...
                            onThemedIconsToggle = { enabled ->
                                callbacks.onApplySettingsCommand(
                                    SettingsCommand.Toggle(
                                        key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.THEMED_ICONS,
                                        enabled = enabled,
                                    ),
                                )
                            },
                            ...
                            onDeviceThemeToggle = { enabled ->
                                callbacks.onApplySettingsCommand(
                                    SettingsCommand.Toggle(
                                        key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.DEVICE_THEME,
                                        enabled = enabled,
                                    ),
                                )
                            },
                            ...
                            onWallpaperAccentToggle = { enabled ->
                                callbacks.onApplySettingsCommand(
                                    SettingsCommand.Toggle(
                                        key = com.myst25.quicksearch.search.appSettings.AppSettingsToggleKey.WALLPAPER_ACCENT,
                                        enabled = enabled,
                                    ),
                                )
                            },
