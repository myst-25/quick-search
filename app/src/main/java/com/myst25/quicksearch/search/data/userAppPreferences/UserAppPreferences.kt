package com.myst25.quicksearch.search.data

import android.content.Context
import com.myst25.quicksearch.search.core.CallingApp
import com.myst25.quicksearch.search.core.CustomSearchEngine
import com.myst25.quicksearch.search.core.CustomTool
...
import com.myst25.quicksearch.search.data.preferences.*
import com.myst25.quicksearch.search.models.FileType
import com.myst25.quicksearch.search.searchHistory.SearchHistoryPreferences
import com.myst25.quicksearch.searchEngines.AliasValidator.isValidGeneralAliasCode
import com.myst25.quicksearch.searchEngines.AliasValidator.normalizeShortcutCodeInput
import com.myst25.quicksearch.tools.aiSearch.AiSearchLlmProviderId
import com.myst25.quicksearch.tools.aiSearch.CustomLlmProviderConfig
import com.myst25.quicksearch.tools.aiSearch.OpenAiModelCatalog
...
class UserAppPreferences(
    ...
    private val sharedPrefs by lazy {
        context.getSharedPreferences(
                com.myst25.quicksearch.search.data.preferences.BasePreferences.PREFS_NAME,
    ...
    fun isDirectDialManuallyDisabled(): Boolean =
            sharedPrefs.getBoolean(
                    com.myst25.quicksearch.search.data.preferences.BasePreferences
    ...
    fun getEnabledFileTypes(): Set<com.myst25.quicksearch.search.models.FileType> =
            filePreferences.getEnabledFileTypes()

    fun setEnabledFileTypes(enabled: Set<com.myst25.quicksearch.search.models.FileType>) =
            filePreferences.setEnabledFileTypes(enabled)

    fun clearEnabledFileTypes(): Set<com.myst25.quicksearch.search.models.FileType> =
    ...
    fun getAllContactActionTriggers():
            Map<com.myst25.quicksearch.search.data.preferences.ContactActionTriggerKey, ResultTrigger> =
    ...
    fun getAppThemeMode(): com.myst25.quicksearch.search.core.AppThemeMode = uiPreferences.getAppThemeMode()

    fun setAppThemeMode(theme: com.myst25.quicksearch.search.core.AppThemeMode) =
    ...
    fun getAppIconShape(): com.myst25.quicksearch.search.core.AppIconShape =
            uiPreferences.getAppIconShape()

    fun setAppIconShape(shape: com.myst25.quicksearch.search.core.AppIconShape) =
            uiPreferences.setAppIconShape(shape)

    fun getLauncherAppIcon(): com.myst25.quicksearch.search.core.LauncherAppIcon =
            uiPreferences.getLauncherAppIcon()

    fun setLauncherAppIcon(selection: com.myst25.quicksearch.search.core.LauncherAppIcon) =
    ...
    fun getRecentItems(): List<com.myst25.quicksearch.search.searchHistory.RecentSearchEntry> =
            recentSearchesPreferences.getRecentItems()

    fun addRecentItem(entry: com.myst25.quicksearch.search.searchHistory.RecentSearchEntry) {
        if (entry is com.myst25.quicksearch.search.searchHistory.RecentSearchEntry.Query) {
    ...
    fun getRecentResultOpens(): List<com.myst25.quicksearch.search.searchHistory.RecentSearchEntry> =
    ...
    fun deleteRecentItem(entry: com.myst25.quicksearch.search.searchHistory.RecentSearchEntry) {
