...
import com.myst25.quicksearch.search.data.preferences.ResultTrigger
...
class SearchViewModelManagementApiDelegate internal constructor(
    ...
    private val userPreferences: com.myst25.quicksearch.search.data.UserAppPreferences,
    ...
    private val appManager: () -> com.myst25.quicksearch.search.apps.AppManagementService,
    private val contactManager: () -> com.myst25.quicksearch.search.contacts.utils.ContactManagementHandler,
    private val fileManager: () -> com.myst25.quicksearch.search.files.FileManagementHandler,
    private val settingsManager: () -> com.myst25.quicksearch.search.deviceSettings.DeviceSettingsManagementHandler,
    private val calendarManager: () -> com.myst25.quicksearch.search.calendar.CalendarManagementHandler,
    private val appShortcutManager: () -> com.myst25.quicksearch.search.appShortcuts.AppShortcutManagementHandler,
    private val notesRepository: () -> com.myst25.quicksearch.search.data.NotesRepository,
    private val appSearchManager: () -> com.myst25.quicksearch.search.apps.AppSearchManager,
