...
internal interface SearchViewModelPreferencesApi {
    ...
    fun setFileTypeEnabled(fileType: com.myst25.quicksearch.search.models.FileType, enabled: Boolean) =
...
class SearchViewModelPreferencesApiDelegate internal constructor(
    ...
    private val webSuggestionHandler: com.myst25.quicksearch.search.webSuggestions.WebSuggestionHandler,
    private val iconPackHandler: com.myst25.quicksearch.search.apps.IconPackService,
