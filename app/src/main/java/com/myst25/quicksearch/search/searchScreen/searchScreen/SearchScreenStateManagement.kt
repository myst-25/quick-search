...
import com.myst25.quicksearch.search.contacts.utils.ContactCallingAppResolver
import com.myst25.quicksearch.search.contacts.utils.ContactMessagingAppResolver
...
import com.myst25.quicksearch.search.searchScreen.buildSectionParams
import com.myst25.quicksearch.search.searchScreen.rememberDerivedState
...
import com.myst25.quicksearch.search.searchScreen.OneHandedModeScrollBehavior
import com.myst25.quicksearch.search.searchScreen.ScrollBasedKeyboardBehavior
...
internal fun SearchScreenStateManagement(
    ...
    onSearchTargetClick: (String, com.myst25.quicksearch.search.core.SearchTarget) -> Unit,
    ...
    onDirectDialChoiceSelected: (com.myst25.quicksearch.search.core.DirectDialOption, Boolean) -> Unit,
    ...
    com.myst25.quicksearch.search.searchScreen.OneHandedModeScrollBehavior(
    ...
    com.myst25.quicksearch.search.searchScreen.ScrollBasedKeyboardBehavior(
        scrollState = scrollState,
