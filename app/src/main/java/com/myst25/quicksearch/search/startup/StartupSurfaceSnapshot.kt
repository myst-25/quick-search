package com.myst25.quicksearch.search.startup
    ...
    fun fromJson(raw: String?): StartupSurfaceSnapshot? {
        ...
        return runCatching {
            ...
            StartupSurfaceSnapshot(
                ...
                phoneAppGridColumns = root.optInt(KEY_PHONE_APP_GRID_COLUMNS, com.myst25.quicksearch.search.data.preferences.UiPreferences.DEFAULT_PHONE_APP_GRID_COLUMNS),
                appIconSizeStep =
                    root.optInt(
