package com.myst25.quicksearch.search.common

import com.myst25.quicksearch.search.core.PermissionManager
...
class PinningHandler(
    ...
    private fun loadPinnedContacts(hasPermission: Boolean): List<com.myst25.quicksearch.search.models.ContactInfo> {
    ...
    private fun loadPinnedFiles(hasPermission: Boolean): List<com.myst25.quicksearch.search.models.DeviceFile> {
        if (!hasPermission) return emptyList()
    ...
    private fun loadExcludedContacts(hasPermission: Boolean): List<com.myst25.quicksearch.search.models.ContactInfo> {
        if (!hasPermission) return emptyList()
    ...
    private fun loadExcludedFiles(hasPermission: Boolean): List<com.myst25.quicksearch.search.models.DeviceFile> {
        if (!hasPermission) return emptyList()
