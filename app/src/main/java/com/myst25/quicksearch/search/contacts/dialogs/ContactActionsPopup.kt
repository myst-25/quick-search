package com.myst25.quicksearch.search.contacts.dialogs
...
import com.myst25.quicksearch.search.contacts.components.ContactActionButton
import com.myst25.quicksearch.search.contacts.components.ContactAvatar
import com.myst25.quicksearch.search.contacts.components.ContactMethodIcon
import com.myst25.quicksearch.search.contacts.components.getActionButtonLabel
...
import com.myst25.quicksearch.search.models.ContactMethodMimeTypes
import com.myst25.quicksearch.search.utils.PhoneNumberUtils
...
internal sealed interface ContactActionsPopupState {
    data class ContactActions(
        ...
        val getContactActionTrigger: (ContactInfo, ContactCardAction) -> com.myst25.quicksearch.search.data.preferences.ResultTrigger? =
            { _, _ -> null },
...
private fun RemainingMethodsList(
    ...
    getContactActionTrigger: (ContactInfo, ContactCardAction) -> com.myst25.quicksearch.search.data.preferences.ResultTrigger? =
        { _, _ -> null },
...
private fun ContactActionLongPressMenu(
    ...
    DropdownMenu(
        ...
        containerColor = com.myst25.quicksearch.shared.ui.theme.AppColors.DialogBackground,
    ) {
        DropdownMenuItem(
