...
class SearchHistoryPreferences(
    ...
    fun getRecentItems(): List<RecentSearchEntry> {
        val rawItems =
            com.myst25.quicksearch.search.data.preferences.PreferenceUtils.getStringListPref(
                sessionPrefs,
    ...
    fun addRecentItem(entry: RecentSearchEntry) {
        ...
        com.myst25.quicksearch.search.data.preferences.PreferenceUtils.setStringListPref(
            sessionPrefs,
            BasePreferences.KEY_RECENT_QUERIES,
            serialized,
        )
