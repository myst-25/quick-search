package com.myst25.quicksearch.search.searchScreen.shared
...
/**
 * Search-screen card wrapper (counterpart to [com.myst25.quicksearch.settings.shared.SettingsCard]).
