...
class IconPackService(
    ...
    fun prefetchVisibleAppIcons(
        pinnedApps: List<com.myst25.quicksearch.search.models.AppInfo>,
        recents: List<com.myst25.quicksearch.search.models.AppInfo>,
        searchResults: List<com.myst25.quicksearch.search.models.AppInfo>,
    ) {
