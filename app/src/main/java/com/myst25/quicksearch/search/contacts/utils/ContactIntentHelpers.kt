...
import com.myst25.quicksearch.search.contacts.actions.CallSmsActions
import com.myst25.quicksearch.search.contacts.actions.CustomAppActions
import com.myst25.quicksearch.search.contacts.actions.GoogleMeetActions
import com.myst25.quicksearch.search.contacts.actions.SignalActions
import com.myst25.quicksearch.search.contacts.actions.TelegramActions
import com.myst25.quicksearch.search.contacts.actions.WhatsAppActions
...
object ContactIntentHelpers {
    ...
    fun openCustomAppWithDataId(
        ...
        if (!success) {
            onShowToast?.invoke(com.myst25.quicksearch.R.string.error_action_not_available)
        }
        return success
    }
