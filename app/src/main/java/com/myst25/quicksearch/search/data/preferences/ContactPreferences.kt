...
class ContactPreferences(
    ...
    fun getPrimaryContactCardAction(contactId: Long): com.myst25.quicksearch.search.contacts.models.ContactCardAction? {
        val serialized =
            prefs.getString(
        ...
        return serialized?.let {
            com.myst25.quicksearch.search.contacts.models.ContactCardAction
    ...
    fun getSecondaryContactCardAction(contactId: Long): com.myst25.quicksearch.search.contacts.models.ContactCardAction? {
        val serialized =
            prefs.getString(
