...
import com.myst25.quicksearch.searchEngines.resolveSearchTargetShortcutPackageName
    ...
    return when (target) {
        is SearchTarget.Engine -> {
            ...
            candidates.firstOrNull { packageName ->
                ...
                ?: com.myst25.quicksearch.searchEngines.resolveSearchTargetShortcutPackageName(target)
        }
