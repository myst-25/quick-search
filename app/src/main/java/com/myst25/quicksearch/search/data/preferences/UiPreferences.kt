...
import com.myst25.quicksearch.search.core.SearchSectionRegistry
...
class UiPreferences(
    ...
    fun getAppThemeMode(): com.myst25.quicksearch.search.core.AppThemeMode {
        val saved = prefs.getString(KEY_APP_THEME_MODE, null)
        return saved?.let {
            runCatching { com.myst25.quicksearch.search.core.AppThemeMode.valueOf(it) }.getOrNull()
        } ?: com.myst25.quicksearch.search.core.AppThemeMode.SYSTEM
    }
