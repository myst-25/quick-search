...
import com.myst25.quicksearch.settings.settingsDetailScreen.AiBackedToolConfigId
...
internal class SearchPreferencesDelegate(
    ...
    private val secondarySearchOrchestrator: com.myst25.quicksearch.searchEngines.SecondarySearchOrchestrator,
    ...
    fun setIconPackUnsupportedIconMaskEnabled(enabled: Boolean) {
        scope.launch(Dispatchers.IO) {
            ...
            com.myst25.quicksearch.search.apps.invalidateAppIconCache()
        }
    }
