...
import com.myst25.quicksearch.search.appSettings.AppSettingResultRow
import com.myst25.quicksearch.search.appShortcuts.AppShortcutRow
import com.myst25.quicksearch.search.apps.AppItemDropdownMenu
import com.myst25.quicksearch.search.apps.rememberAppIcon
import com.myst25.quicksearch.search.calendar.CalendarEventRow
import com.myst25.quicksearch.search.common.AddToHomeHandler
import com.myst25.quicksearch.search.contacts.components.ContactResultRow
...
import com.myst25.quicksearch.search.core.SectionRenderContext
...
import com.myst25.quicksearch.search.data.AppShortcutRepository.launchStaticShortcut
...
import com.myst25.quicksearch.search.deviceSettings.SettingResultRow
import com.myst25.quicksearch.search.files.FileResultRow
...
import com.myst25.quicksearch.search.notes.NoteRow
import com.myst25.quicksearch.search.searchScreen.components.predictedSubmitHighlight
...
import com.myst25.quicksearch.search.searchScreen.shared.SearchResultCard
import com.myst25.quicksearch.search.searchScreen.shared.SearchResultCardDefaults
import com.myst25.quicksearch.search.utils.SearchRankingUtils
...
private fun TopMatchAppRow(
    ...
    val iconResult =
        rememberAppIcon(
            ...
            forceCircularMask = params.appIconShape == com.myst25.quicksearch.search.core.AppIconShape.CIRCLE,
        )
