...
import com.myst25.quicksearch.search.searchScreen.components.predictedSubmitHighlight as componentsPredictedSubmitHighlight
import com.myst25.quicksearch.search.searchScreen.components.predictedSubmitCardBorder as componentsPredictedSubmitCardBorder
...
internal fun PermissionDisabledCard(
    ...
    actionLabel: String,
    onActionClick: () -> Unit,
) = com.myst25.quicksearch.search.searchScreen.components.PermissionDisabledCard(
    title = title,
    message = message,
...
internal fun UsagePermissionCard(
    ...
    onDismiss: () -> Unit,
) = com.myst25.quicksearch.search.searchScreen.components.UsagePermissionCard(
    modifier = modifier,
...
internal fun InfoBanner(message: String) =
    com.myst25.quicksearch.search.searchScreen.components.InfoBanner(message)
...
internal fun PersistentSearchBar(
    ...
    enabledTargets: List<com.myst25.quicksearch.search.core.SearchTarget>,
    ...
    detectedShortcutTarget: com.myst25.quicksearch.search.core.SearchTarget? = null,
    detectedAliasSearchSection: com.myst25.quicksearch.search.core.SearchSection? = null,
    ...
    modifier: Modifier = Modifier,
) = com.myst25.quicksearch.search.searchScreen.components.PersistentSearchBar(
    query = query,
...
internal fun KeyboardSwitchPill(
    ...
    onClick: () -> Unit,
    modifier: Modifier = Modifier,
) = com.myst25.quicksearch.search.searchScreen.components.KeyboardSwitchPill(
    text = text,
    onClick = onClick,
    modifier = modifier,
)
...
internal fun OpenKeyboardAction(
    ...
    modifier: Modifier = Modifier,
) = com.myst25.quicksearch.search.searchScreen.components.OpenKeyboardAction(
    text = text,
    onClick = onClick,
    showWallpaperBackground = showWallpaperBackground,
    modifier = modifier,
...
internal fun OverlayExpandPill(
    ...
    onClick: () -> Unit,
    modifier: Modifier = Modifier,
) = com.myst25.quicksearch.search.searchScreen.components.OverlayExpandPill(
    text = text,
    onClick = onClick,
    modifier = modifier,
)
...
internal fun NumberKeyboardOperatorPills(
    ...
    showWallpaperBackground: Boolean = false,
    modifier: Modifier = Modifier,
) = com.myst25.quicksearch.search.searchScreen.components.NumberKeyboardOperatorPills(
...
internal fun EmptyState() =
    com.myst25.quicksearch.search.searchScreen.components.EmptyState()
