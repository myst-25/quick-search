...
import com.myst25.quicksearch.searchEngines.AliasParser
...
data class AppShortcutsSectionParams(
    ...
    val getShortcutTrigger: (String) -> com.myst25.quicksearch.search.data.preferences.ResultTrigger?,
    val showAllResults: Boolean,
    val showExpandControls: Boolean,
    val onExpandClick: () -> Unit,
    val expandedCardMaxHeight: Dp =
...
data class ContactsSectionParams(
    ...
    val onContactMethodClick: (ContactInfo, com.myst25.quicksearch.search.models.ContactMethod) -> Unit,
    ...
    val getContactActionTrigger: (Long, com.myst25.quicksearch.search.contacts.models.ContactCardAction) -> com.myst25.quicksearch.search.data.preferences.ResultTrigger?,
    val getPrimaryContactCardAction: (Long) -> com.myst25.quicksearch.search.contacts.models.ContactCardAction?,
    val getSecondaryContactCardAction: (Long) -> com.myst25.quicksearch.search.contacts.models.ContactCardAction?,
    val onPrimaryActionLongPress: (ContactInfo) -> Unit,
    val onSecondaryActionLongPress: (ContactInfo) -> Unit,
    val onCustomAction: (ContactInfo, com.myst25.quicksearch.search.contacts.models.ContactCardAction) -> Unit,
...
data class NotesSectionParams(
    ...
    val getNoteTrigger: (Long) -> com.myst25.quicksearch.search.data.preferences.ResultTrigger?,
    val showExpandControls: Boolean,
    val onExpandClick: () -> Unit,
    val showWallpaperBackground: Boolean,
    val predictedTarget: PredictedSubmitTarget? = null,
...
internal fun buildSectionParams(
    ...
    getPrimaryContactCardAction: (Long) -> com.myst25.quicksearch.search.contacts.models.ContactCardAction?,
    getSecondaryContactCardAction: (Long) -> com.myst25.quicksearch.search.contacts.models.ContactCardAction?,
    onPrimaryActionLongPress: (ContactInfo) -> Unit,
    onSecondaryActionLongPress: (ContactInfo) -> Unit,
    onCustomAction: (ContactInfo, com.myst25.quicksearch.search.contacts.models.ContactCardAction) -> Unit,
