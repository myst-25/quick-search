...
class SearchViewModelSearchEngineApiDelegate internal constructor(
    ...
    private val aliasHandler: () -> com.myst25.quicksearch.searchEngines.AliasHandler,
    private val sectionManager: () -> SectionManager,
    private val messagingHandler: () -> com.myst25.quicksearch.search.contacts.utils.MessagingHandler,
    private val searchEngineManager: () -> com.myst25.quicksearch.searchEngines.SearchEngineManager,
    private val aiSearchHandler: () -> com.myst25.quicksearch.tools.aiSearch.AiSearchHandler,
    private val releaseNotesHandler: () -> com.myst25.quicksearch.app.ReleaseNotesHandler,
