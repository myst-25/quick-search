...
import com.myst25.quicksearch.search.contacts.components.ContactUiConstants
...
fun ContactResultsSection(
    ...
    getContactTrigger: (Long) -> com.myst25.quicksearch.search.data.preferences.ResultTrigger? = { null },
